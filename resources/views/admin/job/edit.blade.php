...
@section('content')
    ...
    <form action="{{route('admin.job.update', ['job' => $job->job_id])}}" method="post" id="editJobForm">
        @csrf
        @method('put')
        ...
        <input type="text" list="user_name_list" name="name" value="{{old('name') ?? $job->name}}" required>
        @error('name')
            {{$message}}
        @enderror
        ...
        <input type="date" name="request_date" value="{{old('request_date') ?? $job->request_date}}" required>
        @error('request_date')
            {{$message}}
        @enderror
        ...
        <input type="time" name="request_time" value="{{old('request_time') ?? $job->request_time}}" required>
        @error('request_time')
            {{$message}}
        @enderror
